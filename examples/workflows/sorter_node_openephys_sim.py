...
if __name__ == "__main__":
    ...
    with ProcessorContext() as ctx:
        ...
        templateTrainProcessor = MountainsortTemplateProcessor(
            interval=0.01, min_num_spikes=500, training_period=None
        )
        ...
        analog_visualizer = AnalogVisualizer(
            "Synchronized signals", scale=20, buffer_length=6000
        )
        ...
        gui.register_visualizer(
            cluster_vis, filters=["df_sort"], control_targets=templateTrainProcessor
        )
